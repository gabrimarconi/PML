...
```{r, echo = FALSE}
estimated_accuracy_list <- lapply(c("rpart","rf","LogitBoost"))
...
Below I report the distribution of observations in the test dataset across the predicted "classe" categories. My model only predicts category "A" in the test dataset.
